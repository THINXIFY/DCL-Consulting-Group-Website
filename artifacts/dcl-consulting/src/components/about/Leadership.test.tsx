...
describe('Leadership', () => {
  it('renders the eyebrow, headline, name, role, body copy, and all three approach principles', () => {
    render(<Leadership />);
    ...
    for (const title of ['Understand before concluding.', 'Challenge where necessary.', 'Communicate what matters clearly.']) {
