...
const HERO_IMAGE = 'https://picsum.photos/seed/dcl-hero-financial-district/1600/900?grayscale';
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      if (prefersReducedMotion) {
        gsap.set(['.dclAboutHero__rule', '.dclAboutHero__reveal', '.dclAboutHero__revealLine', '.dclAboutHero__imageWrap'], { clearProps: 'all' });
      ...
      tl.fromTo('.dclAboutHero__rule', { scaleX: 0 }, { scaleX: 1, duration: 0.6, ease: 'power2.out' })
        ...
        .fromTo('.dclAboutHero__imageWrap', { clipPath: 'inset(0 0 0 100%)' }, { clipPath: 'inset(0 0 0 0%)', duration: 1 }, '-=0.35')
        .fromTo('.dclAboutHero__reveal--copy', { autoAlpha: 0, y: 14 }, { autoAlpha: 1, y: 0, duration: 0.6, stagger: 0.08 }, '-=0.5')
        .fromTo('.dclAboutHero__reveal--meta', { autoAlpha: 0 }, { autoAlpha: 1, duration: 0.7 }, '-=0.15');
    ...
    <section id="about-hero" ref={rootRef} aria-labelledby="about-hero-title" className="relative flex min-h-[100dvh] flex-col overflow-hidden bg-[#080a0d] text-white">
      ...
      <div className="relative z-10 flex flex-1 flex-col justify-start px-6 pt-28 sm:px-10 lg:px-16 lg:pt-32">
        ...
        <h1
          ...
          className="dclAboutHero__headline dclHome__display mt-8 max-w-[880px] text-[clamp(4rem,7vw,7.375rem)] leading-[.94] tracking-[-.04em]"
        >
        ...
        <div className="mt-10 flex flex-col gap-5 lg:max-w-[620px]">
          <p className="dclAboutHero__reveal dclAboutHero__reveal--copy max-w-[440px] text-[19px] leading-[1.55] text-white/85">
          ...
          <p className="dclAboutHero__reveal dclAboutHero__reveal--copy max-w-[420px] text-[16px] leading-7 text-white/55">
      ...
      <div className="dclAboutHero__imageWrap relative z-10 h-[38vh] min-h-[220px] w-full overflow-hidden lg:h-[40vh]">
        <img
