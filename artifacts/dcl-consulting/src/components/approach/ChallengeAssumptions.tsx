          ...
          {challengeAssumptions.questions.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="overflow-hidden transition-[max-height,opacity] duration-500 ease-out" style={{ maxHeight: active || !isDesktop ? '140px' : '0px', opacity: active || !isDesktop ? 1 : 0 }}>
                  <p className="mt-4 max-w-[46ch] text-[16px] leading-7 text-[#35404a] sm:text-[17px]">{item.copy}</p>
                </div>
              </div>
            );
          })}
